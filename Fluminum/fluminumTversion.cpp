...
int main() {
    ...
    print_header_box("Matrix Operations Program (17)v2.2-ThreadPool", 80);
    print_line_in_box(CYAN + " Strassen Multiplication & Parallel Comparison (ThreadPool Edition) " + RESET, 80, false, Alignment::Center);
    print_footer_box(80); cout << endl;
